...
class Graph_Generation(object):
    ...
    def plot(self):
        ...
        nx.draw_networkx_nodes(self.g,pos=self.node_pos, node_color= 'yellow') #draw nodes
        ...
        nx.draw_networkx_edge_labels(self.g,pos=self.node_pos,edge_labels=arc_weight)#label edges
        plt.show()
